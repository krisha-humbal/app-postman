  ...
  const SubCategory = () => {
    ...
    const dataFetch = async () => {
      try {
        ...
        const subcategories = res.data.data; // Get all subcategories
        ...
        setCategories(categories); // Store all categories
    
        // Update subcategory status if their category is "off"
              ...
              <FormControl fullWidth>
                ...
                >
                  <MenuItem value="" disabled>Select a Category</MenuItem>
                    {categories
                      .filter((cat) => cat.status === "on") // Only show active categories
                      .map((cat) => (
